# moderation cog by OneEyedKnight
# source: https://gist.github.com/OneEyedKnight/9e1b2c939185df87bb6dfff0330df9f0
...
'''
    if not hell: # checks if there is a channel named hell
        ...
        try: # creates the channel and sends a message
            channel = await ctx.create_text_channel('hell', overwrites=overwrites)
...
class Moderation(commands.Cog):
    ...
    '''
    @commands.command(aliases=['p']) # temporary basic purge command, will replace with a improvised version later
